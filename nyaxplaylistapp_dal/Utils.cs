...
namespace nyaxplaylistapp_dal
{
    ...
    {
        public static string ENCRIPTION_DECRYPTION_KEY = "nyax_playlist_app";
        public static string APP_NAME = "nyax playlist app";
        public static string APP_NAME_SB = "nyax playlist app";
